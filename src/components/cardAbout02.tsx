...
export default function CardAbout02(props:CardAboutPropos){
    return(
        <>
           <div className="w-[100%] min-h-[80vh] text-black flex flex-wrap items-center justify-center bg-gray-100">
            <div className="flex flex-col gap-2 items-center justify-center  md:w-[50%] pb-10 md:pb-0">
             ...
             <Image className="w-[100%] min-h-[80vh]" src={props.imag} width={1500} height={1000} alt="about" />
            </div>
          </div>
        </>
    )
