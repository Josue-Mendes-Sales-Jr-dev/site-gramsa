...
export default function NavbarClosed(props: INavbarProps) {
  ...
  return (
    ...
    >
      ...
      <nav className={isShow? "hidden lg:flex w-[45%] h-[90%] items-center justify-center gap-10 rounded" : "absolute top-[0rem] flex w-[100vw] h-[90vh] flex-col items-center justify-center gap-10 rounded bg-teal-950 z-[10]"}>
      ...
      <button className="lg:hidden w-[2%]" id="hamburger">
        {
          isShow? <GiHamburgerMenu className="absolute right-2 z-[30] top-6 text-[2rem] mr-4" onClick={handleClick}/> : <AiOutlineX className="absolute right-2 z-[30] top-6 text-[2rem] mr-4" onClick={handleClick} />
        } 
      </button>
    </div>
